...
const plans = [
  {
    ...
    period: "forever",
    icon: Target,
    description: "Explore ClearEdge Sports",
    features: [
      "View daily MLB games & odds",
      "1 Expert Follow (3 of 5 analysts)",
      "Picks delayed 30 minutes",
      "Virtual prediction game ($1K balance)",
      "Morning Roast blog",
      "Daily trivia",
    ],
    limitations: [
      "No Fade mode",
      "No Sharp or Closer picks",
      "No AI Assistant",
    ],
  ...
  },
  {
    ...
    period: "month",
    icon: Crown,
    description: "The serious analyst's toolkit",
    features: [
      "Everything in Edge Pass",
      "Expert Consensus Alerts (3+ agree)",
