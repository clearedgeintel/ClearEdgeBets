...
interface NBAGame {
  ...
  spread?: { away: string; home: string; awayOdds: number; homeOdds: number } | null;
...
export default function NBAGames() {
  const { data: games = [], isLoading } = useQuery<NBAGame[]>({
            ...
            <CardContent className="p-4">
              ...
              <div className="flex items-center gap-3 mb-3">
                <div className="flex items-center gap-2 flex-1 min-w-0">
                  <img src={game.awayLogo} alt="" className="h-8 w-8" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
                ...
                <div className="flex items-center gap-2 flex-1 min-w-0 justify-end">
                  ...
                  <img src={game.homeLogo} alt="" className="h-8 w-8" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
                </div>
              </div>

              {/* Odds row */}
              {(game.moneyline || game.total || game.spread) && (
                <div className="flex items-center justify-center gap-4 text-[11px] tabular-nums">
                  ...
                  {game.spread && (
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-emerald-400">{game.spread.away}/{game.spread.home}</span>
                    </div>
                  )}
                  {game.total && (
                    <div className="flex items-center gap-1.5">
