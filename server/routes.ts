...
Return JSON:
{
  ...
  // NHL routes defined at top of registerRoutes()
...
Return JSON: { "injuries": [{ "name": "...", "position": "...", "description": "...", "impact": 8, "note": "brief note" }], "overallImpact": 7, "summary": "..." }` }],
  ...
  // ── Newsletter System ── (extracted to server/routes/newsletter.ts)
...
Format as JSON:
{
  ...
  // Virtual Betting routes extracted to ./routes/virtual-bets.ts
